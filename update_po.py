...
PO_PATH = Path("locale/de/LC_MESSAGES/django.po")
...
replacements = {
    ...
    "Geben Sie einen Namen für Ihre aktuelle Filterkonfiguration ein.": (
        "Namen für diese Filter eingeben."
    ),
    ...
    "Sind Sie sicher, dass Sie diese Ansicht löschen möchten? "
    "Dies kann nicht rückgängig gemacht werden.": ("Ansicht unwiderruflich löschen?"),
    ...
    "Aktuelle Filter als benutzerdefinierte Ansicht speichern": (
...
content = content.replace(
    'msgstr "Gesamtaufgaben über alle Plattformen"', 'msgstr "Aufgaben (Alle)"'
)

with PO_PATH.open("w") as f:
    f.write(content)
